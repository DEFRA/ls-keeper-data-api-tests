...
console.log(`[Config] Playwright target baseURL: ${targetBaseUrl}`)
console.log(`[Config] process.env.ENVIRONMENT: '${process.env.ENVIRONMENT}'`)
console.log(`[Config] process.env.BASE_URL: '${process.env.BASE_URL}'`)
