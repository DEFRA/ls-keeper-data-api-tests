...
export const config = {
  ...
  baseUrl: `https://ls-keeper-data-api-tests.${process.env.ENVIRONMENT}.cdp-int.defra.cloud`,
  ...
  commonCapabilities: {
    'bstack:options': {
      buildName: `ls-keeper-data-api-tests-${process.env.ENVIRONMENT}` // configure as required
    }
  },
    ...
    [
      'browserstack',
      {
        ...
        testObservabilityOptions: {
          ...
          buildName: `ls-keeper-data-api-tests-${process.env.ENVIRONMENT}`
        },
